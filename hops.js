const all = [{
  ...
  },
  {
    ...
    name: "Bouclier",
    origin: "France",
    information: "Emerging in 2005, Bouclier is a cross between Alsace-grown Strisselspalt and a wild male from Wye, Kent. It is unclear however if this variety was first developed in the UK or across the Channel in France.",
    purpose: "Aroma & Bittering",
    flavorProfile: "Aromas of herb, grass and spice alongside a citrus and floral character",
    alphaAcid: "5.2%-9%",
    betaAcid: "2.4%-3.3%",
    link: ""
  }, {
    name: "Bramling Cross",
    origin: "UK",
    information: "Bramling Cross is a rather rare breed and is mostly available in the UK. First harvested in 1927 at Wye College its lineage is a cross between Golding and a wild Manitoban (Canadian) hop. It is considered well suited to cask conditioned recipes as well as Christmas and fruit beers.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Notes of lemon, blackcurrant, blackberries and plums particularly when used as a late addition.",
    alphaAcid: "5%-7.8%",
    betaAcid: "2.3%-3.2%",
    link: ""
  }, {
    ...
    name: "Calypso",
    origin: "USA",
    information: "Calypso is a Yakima Valley bred, dual-purpose diploid hop with Hopsteiner lineage on both sides. Despite its aroma-focused origins, it boasts a high alpha acid percentage. In addition to this, Calypso features crisp, fruity aromas and flavors that exhibit elements of apple, pear and stone fruit brightened with hints of lime citrus. It is marvellously complex with an almost understated earthy, tea-like note.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Crisp, fruity aroma. Flavour of Apples, pears, stone fruit and lime citrus.",
    alphaAcid: "12%-14%",
    betaAcid: "5%-6%",
    link: ""
  }, {
    name: "New Zeland Cascade",
    origin: "New Zeland",
    information: "New Zealand Cascade features largely the same pleasant and distinctive ‘Cascade’ characteristics enjoyed by its US twin but are higher in alpha acids. Some dispute this comparison however, noting that while its characteristics are similar, New Zealand grown Cascade is more subdued in both flavor and aroma. Original Cascade was developed from English variety Fuggle and the Russian variety, Serebrianka.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Floral, with elements of citrus and notes of grapefruit",
    alphaAcid: "6%-8%",
    betaAcid: "5%-5.5%",
    link: ""
  }, {
    ...
    name: "Cashmere",
    origin: "USA",
    information: "Developed by Washington State University and released in 2013, Cashmere is the result of a marriage of Cascade and Northern Brewer. Fortuitously, it features alpha acids higher than that of Cascade.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Smooth bitterness, herbal aroma, flavors of lemon, lime and melon",
    alphaAcid: "7.7%-9.1%",
    betaAcid: "3.3%-7.1%",
    link: ""
  },
  {
    ...
    name: "Chinook",
    origin: "USA",
    information: "Chinook hops are suitable for any stage of the boil. They’re not only a natural for American-style Pale Ales and IPAs, but they also find their way into seasonal ales, barley wine and some porters and stouts. The variety is a cross between Petham Golding and a USDA male and features a pine-like, spicy bouquet with robust flavors of grapefruit.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Bouquet of pine and spice",
    alphaAcid: "12%-14%",
    betaAcid: "3%-4%",
    link: ""
  }, {
    name: "Citra",
    origin: "USA",
    information: "American aroma hop Citra was created by John I. Haas, Inc. and Select Botanicals Group joint venture, the Hop Breeding Company. It was released to the brewing world in 2008. Now one of the most coveted high-impact aroma hops in the US, particularly among craft brewers, it boasts a complex lineage that includes the likes of Hallertau Mittelfrüh (father), Tettnanger (US), Brewer’s Gold and East Kent Golding.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Citrus, grapefruit, lime, tropical fruits, harsh bitterness",
    alphaAcid: "10%-15%",
    betaAcid: "3%-4.5%",
    link: ""
  }, {
    name: "Delta",
    origin: "USA",
    information: "Released in 2009, aroma variety Delta is a relatively new kid on the block. It is a Fuggle-type hop, similar to a Willamette, but with a kick. It features a mild and pleasantly spicy aroma of with notes of melon and citrus. Delta is considered ideal for ale finishing.",
    purpose: "Aroma",
    flavorProfile: "Spicy with notes of melon and citrus",
    alphaAcid: "5.5%-7%",
    betaAcid: "5.5%-7%",
    link: ""
  }, {
    name: "Dr Rudi",
    origin: "New Zeland",
    information: "Originally known as SuperAlpha, the variety was renamed to Dr Rudi in 2012. It was bred from New Zealand Smooth Cone and is largely grown in New Zealand. It was originally released in 1976.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Grass, pine and citrus flavors",
    alphaAcid: "10%-12%",
    betaAcid: "7%-8.5%",
    link: ""
  }, {
    name: "Eureka",
    origin: "USA",
    information: "With similarities to Simcoe and Summit hops, Eureka is a fairly new variety with very strong bittering qualities and a complex and robust flavor and aroma profile. It is said to impart flavors of citrus, resin, tropical and dark fruit along with aromas of grapefruit rind, citrus and tangerine. It is the progeny of varietals Apollo and Merkur.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Falvors of citrus, peach and pine, aromas of stone fruit and mandarin",
    alphaAcid: "18%-19%",
    betaAcid: "5%-6%",
    ...
    origin: "USA",
    information: "Falconer’s Flight is a proprietary blend of Pacific Northwest hops. These include 7 “C” hops, Cascade, Centennial, Chinook, Citra, Cluster, Columbus and Crystal in addition to experimental varieties developed by Hopunion LLC.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Distinct tropical, floral, lemon and grapefruit attributes",
    alphaAcid: "9.5%-12%",
    betaAcid: "4%-5%",
    link: ""
  }, {
    name: "First Gold",
    origin: "UK",
    information: "First Gold is a Golding variety, bred from Whitbread Golding and a dwarf variety at Wye College in England. It was released in 1996 and has the distinction of being England’s first hedgerow hop. For brewers, it is useful in just about any style.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Tangerine, orange, cinnamon aroma, marmalade flavors",
    alphaAcid: "5.6%-9.3%",
    betaAcid: "2.3%-4.1%",
    link: ""
  }, {
    name: "Galaxy",
    origin: "Australlia",
    information: "Descended from German variety Perle, Galaxy is a unique Australian breed of hops that has the distinction of sporting the highest percentage of essential oils in the industry.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Citrus, peach and passionfruit aromas",
    alphaAcid: "11%-16%",
    betaAcid: "5%-6.9%",
    link: ""
  }, {
    name: "Glacier",
    origin: "USA",
    information: "Developed by Washington State University and released in 2000, Glacier is a high yielding, dual-purpose hop characterized by low cohumulone levels, giving it a moderate and pleasant bitterness. Glacier’s aroma and flavor notes are herby, woody and citrusy.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Herbs, wood and citrus",
    alphaAcid: "3.3%-9.7%",
    betaAcid: "5.4%-10%",
    link: ""
  },
  {
    name: "Green Bullet",
    origin: "New Zeland",
    information: "Green Bullet is a New Zealand hops variety, one of the first generation of new crosses attempted when Black Root Rot descended on New Zealand hops in 1949.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Aromas of raisin and fruit",
    alphaAcid: "11%-15%",
    betaAcid: "2.9%-7%",
    link: ""
  }, {
    name: "Greensburg",
    origin: "USA",
    information: "Greensburg is an American aroma hop grown mainly in southern Idaho and is used primarily by microbreweries. It has both fruity and woody notes. Its beta acids actually supersede its alpha acid content. Best when added to the end of a boil for aroma.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Fruity, woody aromas",
    alphaAcid: "5.2%",
    betaAcid: "7.2%",
    link: ""
  }, {
    ...
    origin: "Germany",
    information: "German born Hallertau Taurus features an earthy, strong aroma with hints of chocolate and banana, spice and pepper and finishes with a zesty curry undertone. It was released in 1995. Interestingly, it carries the highest xanthohumol content of any hop. Xanthohumol is a potent antioxidant, 200 times more powerful than antioxidants found in red wine. Used in Paulaner’s hop selection for their Oktoberfest bier.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Chocolate, banana, spice, pepper, curry",
    alphaAcid: "12.3%-17.9%",
    betaAcid: "4%-6%",
    link: ""
  }, {
    ...
    name: "Herkules",
    origin: "Germany",
    information: "Strong and robust in flavor and aroma, German Herkules lives up to it’s name. The Hüll-bred offspring of Hallertauer Taurus, Herkules is a high alpha acid bittering hop, known to be spicy and floral, tangy and hoppy, with notes of melon, black pepper, with hints of pine. It was released in 2005.",
    purpose: "Bittering & Aroma",
    flavorProfile: "Notes of melon, black pepper and pine",
    alphaAcid: "12%-17%",
    betaAcid: "4%-5.5%",
    link: ""
  }, {
